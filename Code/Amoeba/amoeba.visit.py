...
while ivol < nvol:
  ...
  strfil = "./nmoeba.00000%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
  if step >= 10:
      strfil = "./nmoeba.0000%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
  if step >= 100:
      strfil = "./nmoeba.000%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
  if step >= 1000:
      strfil = "./nmoeba.00%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
  if step >= 10000:
      strfil = "./nmoeba.0%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
  if step >= 100000:
      strfil = "./nmoeba.%d.vol%d.%dd.hdf5"%(step, ivol, sdim)
