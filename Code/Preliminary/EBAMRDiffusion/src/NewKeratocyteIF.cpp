...
NewKeratocyteIF::NewKeratocyteIF()
{
}

NewKeratocyteIF::NewKeratocyteIF(const NewKeratocyteIF& a_inputIF)
{
}
...
Real NewKeratocyteIF::value(const RealVect& a_point) const
{
...
BaseIF* NewKeratocyteIF::newImplicitFunction() const
{
  // Create and return a copy of this object
  NewKeratocyteIF* newKeratocytePtr = new NewKeratocyteIF();
  return static_cast<BaseIF*>(newKeratocytePtr);
}
